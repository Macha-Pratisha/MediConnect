...
export default function DoctorChat() {
  ...
  const sendMessage = async () => {
    ...
    if (!text) return;
    await fetch("http://localhost:5003/api/doctor-messages", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ text, senderRole: "doctor" }),
    });
    setInput("");
  };
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      <h2 className="text-2xl font-bold mb-4 text-center">Doctor Chat</h2>
